...
-- MAGIC    
-- MAGIC    - A coluna **timestamp** contém um valor de carimbo de data/hora Unix.
...
-- MAGIC %md
-- MAGIC 4. Execute a query abaixo para query a tabela **state_lookup** e visualizar 10 linhas. Observe que a tabela contém nomes de estados abreviados, que podem ser usados para obter os nomes de estados completos.
...
-- MAGIC
-- MAGIC
-- MAGIC | **Informação de Refresh**     |  **Tipo de Dados**                      |
-- MAGIC |-----------------------------|-----------------------------------|
