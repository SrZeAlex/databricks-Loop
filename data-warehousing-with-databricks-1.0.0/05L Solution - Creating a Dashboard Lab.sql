...
-- MAGIC %md
-- MAGIC ![Select table](images/dashboard/lab/selecttable.png)
...
-- MAGIC %md
-- MAGIC ![Visualization](images/dashboard/lab/firstvisualization.png)
...
-- MAGIC %md
-- MAGIC ![Visualization](images/dashboard/lab/secondvisualization.png)
...
-- MAGIC %md
-- MAGIC ![Filter](images/dashboard/lab/filter.png)
...
-- MAGIC %md
-- MAGIC ![Filter](images/dashboard/lab/firstusefilter.png)
...
-- MAGIC %md
-- MAGIC ![Filter](images/dashboard/lab/secondusefilter.png)
